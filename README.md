...
[![npm version](https://img.shields.io/npm/v/satim-payment-module.svg)](https://www.npmjs.com/package/satim-payment-module)
...
```bash
npm install satim-payment-module
```
...
```typescript
import { SatimClient } from 'satim-payment-module';e';
